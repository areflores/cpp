    ...
    while (salir == false )
    {
        ...
        for ( int i = 0 ; i < 5 ; i ++)
        {
            ...
            if ( (libroEnminuscula.find(buscar) != string::npos) || (autorEnminuscula.find(buscar) != string::npos)) {
                ...
                int sugerencia1 = rand ()% 5 ;
                int sugerencia2 = rand ()% 5 ;
                int sugerencia3 = rand ()% 5 ;
